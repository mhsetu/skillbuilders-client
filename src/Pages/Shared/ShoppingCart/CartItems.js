  ...
  return (
    <div>
      <div>
        <button>
          <Link to={`/course/${id}`}>
            <div className=' max-w-[420px] lg:min-w-[600px] bg-base-100 shadow-md flex items-center mb-4 rounded-md  lg:ml-10 md:ml-5 text-left'>
              <div className='avatar m-2'>
                <div className='w-32 max-h-32 rounded'>
                  <img src={image_url} />
                </div>
              </div>
              <div>
